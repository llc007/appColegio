    ...
    <div class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <form method="POST" action="{{route('chirps.store')}}">
            ...
            <textarea
                ...
                class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-100 focus:ring-opacity-10 rounded-md shadow-sm"
                ...
                <div class="p-6 flex space-x-2">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            ...
                            <h1 class="mt-4 text-lg text-gray-900">{{$chirp->message}}</h1>
                    </div>
